...
function Login() {
    ...
    const handleRegister = async (e) => {
        e.preventDefault();
        const userData = {
            name: username, // Assuming the name is entered in the username field
            email: email,
            password: password,
        };

        try {
            const response = await axios.post("http://localhost:5000/admin", userData, {
                headers: {
    ...
    return (
        <div className="flex flex-row w-full h-screen justify-center items-center">
            ...
            <div className="bg-[#000517] flex flex-col justify-center items-center w-2/4 h-[100%] align-right">
                <Card className="w-2/5 h-96 flex flex-col justify-center items-center p-8 shadow-2xl bg-[#000517] rounded-lg">
                    <div>
                        {isLogin ? (
