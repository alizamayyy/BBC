...
const about = () => {
  return (
    ...
    >
      <div>
        <h1 className="font-bold text-7xl text-center mb-4 text-white">
          Meet the Team
        </h1>
        ...
        <div className="mt-24 flex flex-row space-x-16 justify-center">
          <div>
            <Card className="w-[300px] h-[400px] flex flex-col justify-center items-center bg-[#1b1a38] rounded-lg">
          ...
          <div>
            <Card className="w-[280px] h-[400px] flex flex-col justify-center items-center bg-[#1b1a38] rounded-lg">
